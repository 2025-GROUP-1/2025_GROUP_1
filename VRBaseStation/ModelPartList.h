...
public:
    //DELETE THIS LATER NOT NEEDED AFTER HAMZA COMPLETES HIS STUFF
    ...
    QList<ModelPart*> allParts() const;

private:
    ModelPart* rootItem;    /**< This is a pointer to the item at the base of the tree */
    QList<ModelPart*> m_parts; /**< Added this: Flat list of all parts for VR [cite: 539-540] */
};
#endif
