 ...
 * @brief Declares the Qt item model that exposes ModelPart nodes to the tree view.
 */
...
/**
 * @class ModelPartList
 * @brief QAbstractItemModel wrapper around the ModelPart hierarchy used by the parts browser.
 */
